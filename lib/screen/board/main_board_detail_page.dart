...
import 'package:mukgen_flutter_v1/service/post_board_comment.dart';
                          ...
                          return Column(
                            children: [
                              Row(
                                children: [
                                  Text(
                                    snapshot.data!.boardCommentList![index].writer
                                        .toString(),
                                    style: TextStyle(
                                      color: MukGenColor.primaryLight1,
                                      fontFamily: 'MukgenRegular',
                              ...
                              Row(
                                children: [
                                  Text(
                                    snapshot
                                        .data!.boardCommentList![index].content
                                        .toString(),
                                    style: TextStyle(
                                      color: MukGenColor.black,
                                      fontFamily: 'MukgenRegular',
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if(_isButtonEnabled) {
                      setState(() {
                        postBoardComment(widget.boardId, commentController.text);
                  ...
                  child: Container(
                    ...
                    height: 32.0.h,
                    decoration: BoxDecoration(
                      color: _isButtonEnabled ? MukGenColor.pointLight1 : MukGenColor.primaryLight2,
