...
class MainReviewDetailPage extends StatefulWidget {
  const MainReviewDetailPage(
      {Key? key, required this.riceType, required this.reviewId})
      : super(key: key);
...
class _MainReviewDetailPageState extends State<MainReviewDetailPage> {
  ...
  List<String> foodImage = ['MORNING.png', 'LUNCH.png', 'DINNER.png'];
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          FutureBuilder(
            future:
                Future.wait([todayMeal, detailReview].cast<Future<dynamic>>()),
            builder: (context, snapshot) {
              int mealIndex = widget.riceType == "BREAKFAST"
                  ? 0
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: todayMeal
                                      .responseList![mealIndex].items!.length,
                                  itemBuilder: (context, index) {
                                    final itemList = _parseItemList(todayMeal
                                        .responseList![mealIndex].items
                                        .toString());
                                    return Row(
                                      children: [
                                        Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      height: 25.0.h,
                                      child: Image.asset(
                                          riceTypeToImage[widget.riceType]!),
                                    ),
                                  ],
                                ),
                              ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              DateFormat('yy.MM.dd HH:mm')
                                  .format(
                                      DateTime.parse(detailReview.createdAt!))
                                  .toString(),
                              style: TextStyle(
                                color: MukGenColor.primaryLight2,
                                fontSize: 12.sp,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              padding: EdgeInsets.zero,
                              itemCount: detailReview
                                  .reviewCommentResponseList!.length,
                              itemBuilder: (context, reviewIndex) {
                                DateTime postTime = DateTime.parse(detailReview
                                    .reviewCommentResponseList![reviewIndex]
                                    .createdAt
                                    .toString());
                                ...
                                int minutesDifference = difference
                                    .inMinutes; // 올린 시간과 현재 시간의 차이 (분 단위)
                                int hoursDifference = difference
                                    .inHours; // 올린 시간과 현재 시간의 차이 (시간 단위)
                                int daysDifference = difference
                                    .inDays; // 올린 시간과 현재 시간의 차이 (일 단위)
                                int monthsDifference =
                                    (currentTime.year - postTime.year) * 12 +
                                        currentTime.month -
                                        postTime
                                            .month; // 올린 시간과 현재 시간의 차이 (달 단위)
